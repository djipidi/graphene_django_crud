# Generated by Django 3.1.5 on 2021-02-18 08:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=100, null=True)),
                ('TestO2oC', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='tests.testo2oc')),
            ],
        ),
        migrations.CreateModel(
            name='TestO2oA',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=100, null=True)),
                ('TestO2oB', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='testO2oA', to='tests.testo2ob')),
            ],
        ),
        migrations.CreateModel(
            name='TestM2mB',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=100, null=True)),
                ('testM2mCs', models.ManyToManyField(to='tests.TestM2mC')),
            ],
        ),
        migrations.CreateModel(
            name='TestM2mA',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=100, null=True)),
                ('testM2mBs', models.ManyToManyField(related_name='testM2mAs', to='tests.TestM2mB')),
            ],
        ),
        migrations.CreateModel(
            name='TestFkB',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=100, null=True)),
                ('testFkC', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tests.testfkc')),
            ],
        ),
        migrations.CreateModel(
            name='TestFkA',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(blank=True, max_length=100, null=True)),
                ('testFkB', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='testFkAs', to='tests.testfkb')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
